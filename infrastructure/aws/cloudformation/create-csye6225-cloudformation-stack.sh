...
#aws cloudformation create-stack --stack-name teststack --template-body file:///home/jyoti/csyeGit/csye6225-fall2017-1/infrastructure/aws/cloudformation/createStack.json --capabilities "CAPABILITY_NAMED_IAM" --parameters ParameterKey=imgId,ParameterValue=ami-cd0f5cb6 ParameterKey=vpcId,ParameterValue=vpc-f7bc7c8e ParameterKey=keyName,ParameterValue=ec2key ParameterKey=snapshotId,ParameterValue=snap-0cfc17b071e696816 ParameterKey=InstType,ParameterValue=t2.micro ParameterKey=volumeSize,ParameterValue=16 ParameterKey=volumeType,ParameterValue=gp2 ParameterKey=hostedZoneId,ParameterValue=Z2DH59WEOS3S7Z ParameterKey=dnsName,ParameterValue=ec2.csye6225-fall2017-sharmaj.me ParameterKey=recordSetType,ParameterValue=A ParameterKey=recordSetTTL,ParameterValue=60 ParameterKey=rdsParamUsername,ParameterValue=csye6225master ParameterKey=rdsParamPassword,ParameterValue=csye6225password
